...
const streamerLegends = streamers.filter(individuo => {
    if(individuo.age > 40) individuo.gameMorePlayed = individuo.gameMorePlayed.toUpperCase();
    return individuo.gameMorePlayed.toLowerCase().includes('legends');
