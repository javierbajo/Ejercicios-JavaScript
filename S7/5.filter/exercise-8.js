...
const asignar = (caracteresEntrada) => {
    ...
    const streamerFiltrados = streamers.filter(individuo => individuo.name.includes(caracteresEntrada));
    console.log(streamerFiltrados);
    console.log(...streamerFiltrados.map(individuo => individuo.name));
...
button$$.addEventListener('click', () => asignar(input$$.value))